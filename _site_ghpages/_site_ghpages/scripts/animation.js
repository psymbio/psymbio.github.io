! function(t, e) { "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports._vantaEffect = e() : t._vantaEffect = e() }("undefined" != typeof self ? self : this, (function() {
    return function(t) {
        ...
        return i.m = t, i.c = e, i.d = function(t, e, s) { i.o(t, e) || Object.defineProperty(t, e, { enumerable: !0, get: s }) }, i.r = function(t) { "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(t, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(t, "__esModule", { value: !0 }) }, i.t = function(t, e) {
            ...
            return s
        }, i.n = function(t) { var e = t && t.__esModule ? function() { return t.default } : function() { return t }; return i.d(e, "a", e), e }, i.o = function(t, e) { return Object.prototype.hasOwnProperty.call(t, e) }, i.p = "", i(i.s = 16)
    }({
        0: function(t, e, i) {
            "use strict";
            ...
            i.d(e, "c", (function() { return s })), i.d(e, "e", (function() { return o })), i.d(e, "i", (function() { return n })), i.d(e, "h", (function() { return r })), i.d(e, "g", (function() { return h })), i.d(e, "f", (function() { return a })), i.d(e, "a", (function() { return u })), i.d(e, "b", (function() { return c })), i.d(e, "d", (function() { return d })), Number.prototype.clamp = function(t, e) { return Math.min(Math.max(this, t), e) };
            ...
            const a = t => document.querySelector(t),
                u = t => "number" == typeof t ? "#" + ("00000" + t.toString(16)).slice(-6) : t,
                c = (t, e = 1) => {
                    const i = u(t),
        ...
        16: function(t, e, i) {
            ...
            class r extends s.b {
                static initClass() { this.prototype.p5 = !0, this.prototype.defaultOptions = { color: 9979487, backgroundColor: 2237478, spacing: 0, chaos: 1 } }
                ...
                onInit() {
                    ...
                    this.p5 = new n((function(e) {
                        ...
                        function l(t, i, s) { let o = t % e.TWO_PI; return o < 0 && (o += e.TWO_PI), e.noise(u + e.cos(o) * i, c + e.sin(o) * i, d + s) }
                        e.setup = function() { t.initP5(e), e.strokeWeight(1), e.stroke(Object(o.a)(t.options.color)), e.smooth(), e.noFill() }, e.draw = function() {
                            e.clear(), e.translate(e.width / 2, e.height / 2),
                                function() {
                                    c -= .02, d += 5e-5;
                                    for (let o = 0; o < i; o++) {
                                        e.beginShape();
                                        for (let i = 0; i < 360; i++) {
                                            let u = e.radians(i),
                                                c = t.options.chaos * a * l(u, h * o + r, d) + (n * o + s) + (o * t.options.spacing || 0);
        ...
        3: function(t, e, i) {
            ...
            var s = i(1),
                o = i(0);
            i.d(e, "a", (function() { return s.a }));
            let n = "object" == typeof window && window.p5;
            class r extends s.b {
                constructor(t) { n = t.p5 || n, super(t), this.mode = "p5" }
                initP5(t) {
                    const e = this,
                        i = t.createCanvas(e.width, e.height);
                    i.parent(e.el), e.applyCanvasStyles(t.canvas, { background: Object(o.a)(e.options.backgroundColor) }), e.p5renderer = i, e.p5canvas = t.canvas, e.p5 = t
                }
